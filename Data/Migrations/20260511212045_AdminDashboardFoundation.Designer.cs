...
namespace EmployeeDirectory.Data.Migrations
{
    ...
    [Migration("20260511212045_AdminDashboardFoundation")]
    partial class AdminDashboardFoundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeDirectory.Models.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("EmployeeDirectory.Models.OtpVerification", b =>
                {
            ...
            modelBuilder.Entity("EmployeeDirectory.Models.AuditLog", b =>
                {
                    b.HasOne("EmployeeDirectory.Models.ApplicationUser", "ActingUser")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeDirectory.Models.Employee", b =>
                {
                    ...
                    b.HasOne("EmployeeDirectory.Models.Employee", "Manager")
                        .WithMany()
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EmployeeDirectory.Models.ApplicationUser", "User")
                        .WithMany()
